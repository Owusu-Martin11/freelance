   ...
   <section id="about">
      ...
      <div class="row">
         ...
         <div class="three columns">
            ...
            <img class="profile-pic"  src="profile_asset/images/my_dp.jpg" alt="My display picture" />
         ...
         <div class="nine columns main-col">
            ...
            <div class="row">
               ...
               <!-- <div class="columns download">
                  <p>
                     <a href="#" class="button"><i class="fa fa-download" src=""></i>Download Resume</a>
                  </p>
               </div> -->
      ...
      ----------------------------------------------- -->
       <div class="row skill">
         ...
         <div class="nine columns main-col">
            ...
            <p>After completing the Intro to Web Development course at the University of Ghana, I gained a hands-on knowledge and practical usages of the following Web development tools listed below. I have since been practising and building a few projects on my own, which you can view in the "Works" section on this website. I will admit that most of them could be improved upon.
            </p>
            ...
            <div class="ten columns flex-container">
               ...
               <div class="flexslider">
                  ...
                  <ul class="slides">
                     ...
                     <!--<li>
                        <blockquote>
                           <p>Martin was really a great student who availed himself for punctuality, excellence and above all timely submission of projects during his time in the study of web development course. 
                           </p>
                           <cite>Mr. Kwesi Arthur - Lecturer</cite>
                        </blockquote>
                     </li>--> <!-- slide ends -->

                     <!--<li>
                        <blockquote>
                           <img src="..\images\my_dp.jpg" alt="" style="width:90px">
                           <p>Martin was really a great student who availed himself for punctuality, excellence and above all timely submission of projects during his time in the study of web development course. 
                           </p>
                           <cite>Mr. Kwesi Arthur - Lecturer</cite>
                        </blockquote>
